...
export const metadata: Metadata = {
  ...
  description:
    "Answer a few questions to get a tailored plan. Transparent two-part pricing with a one-time build fee plus a simple monthly retainer.",
  openGraph: {
    title: "Pricing · Build Your Footprint",
    description: "Your right plan, in 60 seconds.",
  },
};
              ...
              <AccordionItem value="all" className="border-b-0">
                <AccordionTrigger className="px-6 md:px-8 py-5 hover:no-underline">
                  <div className="text-left">
                    <div className="text-xs uppercase tracking-[0.25em] text-accent mb-1">Prefer to browse</div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-14 text-center">
              <Button variant="hero" size="lg" asChild>
                <Link href="/contact">Get a custom quote <ArrowRight className="h-4 w-4" /></Link>
              </Button>
            </div>
          </div>
        </div>
