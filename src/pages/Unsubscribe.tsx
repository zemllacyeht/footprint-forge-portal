...
const Unsubscribe = () => {
  ...
  return (
    <PageLayout title="Unsubscribe · Build Your Footprint" description="Manage your email preferences.">
          ...
          <div className="glass rounded-2xl p-10 text-center">
            ...
            {state === "ready" && (
              <>
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Confirm to stop receiving emails at <span className="text-foreground">{email}</span>.
                </p>
                <Button variant="hero" onClick={confirm}>Confirm unsubscribe</Button>
              </>
            )}
            {state === "submitting" && (
              <>
            ...
            {state === "done" && (
              <>
                ...
                <Button variant="glass" asChild><Link to="/">Back to home</Link></Button>
              </>
            )}
            {state === "already" && (
              <>
            ...
            {(state === "invalid" || state === "error") && (
              <>
                <div className="h-12 w-12 rounded-full bg-destructive/15 grid place-items-center mx-auto mb-4">
